...
import eu.planlos.javapretixconnector.service.api.PretixApiItemCategoryService;
import eu.planlos.javapretixconnector.service.api.PretixApiItemService;
...
public class ProductService {
    ...
    private Optional<Product> fetchProduct(@NotNull String event, @NotNull PretixId pretixId, @NotNull PretixId pretixVariationId) {
        ...
        return saveProducts(productList).stream().filter(streamedProduct -> {
            if (streamedProduct.getPretixVariationId() == null || streamedProduct.getPretixVariationId().getIdValue() == null && pretixVariationId == null) {
                return true;
            }
    ...
    public Product loadOrFetchProduct(String event, PretixId pretixId, PretixId pretixVariationId) {
        ...
        // Get from DB
        if(pretixVariationId == null || pretixVariationId.getIdValue() == null) {
